...
<div class="header pb-6 bg-primary">
    <div class="container-fluid">
        ...
        <div class="row align-items-center py-4">
            ...
            <h6 class="h2 d-inline-block mb-0 text-white">Webmaster</h6>
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                <li class="breadcrumb-item"><a href="{{ url('/') }}"><i class="fas fa-home"></i></a></li>
                <li class="breadcrumb-item active"><a href="{{ route('webmaster') }}">Webmaster</a></li>
                </ol>
            </nav>
            </div>
            <div class="col-lg-6 col-5 text-right">
            <a href="{{ route('addwebmaster') }}" class="btn btn-sm btn-neutral">Add Webmaster</a>
            </div>
        </div>
        </div>
    </div>
                        ...
                        <table class="table table-hover table-flush" id="datatable-basic">
                            ...
                            <tbody>
                              ...
                              <tr>
                                  ...
                                  <td>
                                  <a href="/webmaster/{{$webmastersy->id}}/editwebmaster/" class="btn btn-info btn-sm m-0" data-toggle="tooltip" title="Edit Webmaster"><i class="fas fa-pen"></i></a>
                                      <form action="/webmaster/{{$webmastersy->id}}" method="post" class="m-0" style="display:inline-block;">
                                          {{ csrf_field() }}
                                          <input type="hidden" name="_method" value="DELETE">
                                          <button type="submit" class="btn btn-warning btn-sm" data-toggle="tooltip" title="Delete Webmaster"><i class="fas fa-trash"></i></button>
                                      </form>
                                  </td>
                              </tr>
                              @endforeach
