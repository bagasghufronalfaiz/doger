    ...
    <div class="container-fluid">
        ...
        <div class="row align-items-center py-4">
            ...
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                ...
                <li class="breadcrumb-item active"><a href="{{ route('addwebmaster') }}">Add Webmaster</a></li>
                </ol>
            </nav>
            </div>
        </div>
          ...
          <div class="card-wrapper">
            ...
            <div class="card">
              ...
              <div class="card-header">
                <h3 class="mb-0">Edit Webmaster</h3>
              </div>
              <!-- Card body -->
              <div class="card-body">
                <form action="/webmaster/{{$webmaster->id}}" method="post">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                          ...
                          <input class="form-control" placeholder="Name" type="text" name="name" value="{{(old('name')) ? old('name') : $webmaster->name}}">
                      </div>
                    </div>                    
                    <div class="col-md-12">
                      <div class="form-group">
                          <label for="email">Email</label>
                          <input class="form-control" placeholder="Email" type="email" name="email" value="{{(old('email')) ? old('email') : $webmaster->email}}">
                      </div>
                    </div>
                  ...
                  <input type="hidden" name="_method" value="PUT">
                      ...
                      @endif
                    <input type="submit" class="btn btn-primary" value="Edit Webmaster">
                </form>
              </div>
            </div>
          </div>
