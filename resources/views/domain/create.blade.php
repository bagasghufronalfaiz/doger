    ...
    <div class="container-fluid">
        ...
        <div class="row align-items-center py-4">
            ...
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                ...
                <li class="breadcrumb-item active"><a href="{{ route('adddomain') }}">Add Domain</a></li>
                </ol>
            </nav>
            </div>
        </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input class="form-control" id="inputdomain" oninput="getdomain()" type="text" name="domain" value="{{old('domain')}}" placeholder="Domain">
