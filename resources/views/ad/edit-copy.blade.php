              ...
              <div class="card-body">
                  <form action="/ad/{{$ad->id}}" method="post">
                      ...
                      <div class="form-group bmd-form-group" style="margin-top:20px;">
                          ...
                          <textarea class="form-control" rows="11" name="code">{{(old('code')) ? old('code') : $ad->code}}</textarea>
                      </div>
                      ...
                      @endif
                      <input type="submit" class="btn btn-warning" value="Edit Ad" style="margin-top:20px;">
                  </form>
              </div>
          </div>
      </div>
