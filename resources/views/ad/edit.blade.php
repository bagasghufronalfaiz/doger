...
<div class="header pb-6 bg-primary">
    <div class="container-fluid">
        ...
        <div class="row align-items-center py-4">
            ...
            <h6 class="h2 d-inline-block mb-0 text-white">Ad</h6>
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                <li class="breadcrumb-item"><a href="{{ url('/') }}"><i class="fas fa-home"></i></a></li>
                <li class="breadcrumb-item active"><a href="{{ route('ad') }}">Ad</a></li>
                <li class="breadcrumb-item active"><a href="">Edit Ad</a></li>
                </ol>
            </nav>
            </div>
        </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                          ...
                          <input class="form-control" placeholder="Email" type="email" name="email" value="{{(old('email')) ? old('email') : $ad->email}}">
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group">
                          <label for="name">Name</label>
                          <input class="form-control" placeholder="Name" type="text" name="name" value="{{(old('name')) ? old('name') : $ad->name}}">
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group">
                          <label for="code">Code</label>
                          <textarea class="form-control" rows="11" name="code" placeholder="Code">{{(old('code')) ? old('code') : $ad->code}}</textarea>
                      </div>
                    </div>
