    ...
    <div class="container-fluid">
        ...
        <div class="row align-items-center py-4">
            ...
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                ...
                <li class="breadcrumb-item active"><a href="{{ route('addad') }}">Add Ad</a></li>
                </ol>
            </nav>
            </div>
        </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                          ...
                          <input class="form-control" placeholder="Ad Network" type="text" name="ad_network" value="{{old('ad_network')}}">
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                          ...
                          <textarea class="form-control" rows="11" name="code" placeholder="Code">{{old('code')}}</textarea>
                      </div>
                    </div>
