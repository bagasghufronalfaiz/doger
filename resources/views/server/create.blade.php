                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                          ...
                          <input class="form-control" placeholder="Seller" type="text" name="seller" value="{{old('seller')}}">
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group">
                          <label for="location">Location</label>
                          <input class="form-control" placeholder="Location" type="text" name="location" value="{{old('location')}}">
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group">
                          <label for="servername">Server Name</label>
                          <input class="form-control" placeholder="Server Name" type="text" name="servername" value="{{old('servername')}}">
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group">
                          <label for="ip">IP</label>
                          <input class="form-control" placeholder="IP" type="text" name="ip" value="{{old('ip')}}">
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input class="form-control datepicker" placeholder="Invoice Date" type="text" value="{{date('m/d/Y')}}" name="invoice_date">
                      </div>
                    </div>
                  </div>
                  {{ csrf_field() }}
